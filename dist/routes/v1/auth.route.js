...
router.post('/logout', (0, validate_1.default)(auth_validation_1.default.logout), auth_controller_1.default.logout);
router.post('/refresh-tokens', (0, validate_1.default)(auth_validation_1.default.refreshTokens), auth_controller_1.default.refreshTokens);
